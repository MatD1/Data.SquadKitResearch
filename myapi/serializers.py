...
class ChangelogSerializer(serializers.HyperlinkedModelSerializer):
    class Meta: 
        model = Changelog
        fields = ['id','UpdateName', 'body', 'createdat'];
